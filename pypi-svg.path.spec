...
Version  : 6.0
Release  : 31
URL      : https://files.pythonhosted.org/packages/09/6e/4131a9aacc0ed5124e609bc1123d1019f4a09e8bb67bc8873c6ef0a17c52/svg.path-6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/09/6e/4131a9aacc0ed5124e609bc1123d1019f4a09e8bb67bc8873c6ef0a17c52/svg.path-6.0.tar.gz
...
%prep
%setup -q -n svg.path-6.0
cd %{_builddir}/svg.path-6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649948200
...
cp %{_builddir}/svg.path-6.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-svg.path/d14a2577da362843bb255e84ec3c2dd4bfd47f50
