...
Version  : 6.1
Release  : 33
URL      : https://files.pythonhosted.org/packages/f4/c9/06af3ea1ba25332f9f6be62b94d1b740780424680edab00c4a409adf1196/svg.path-6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/f4/c9/06af3ea1ba25332f9f6be62b94d1b740780424680edab00c4a409adf1196/svg.path-6.1.tar.gz
...
%prep
%setup -q -n svg.path-6.1
cd %{_builddir}/svg.path-6.1
pushd ..
cp -a svg.path-6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654792574
...
cp %{_builddir}/svg.path-6.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-svg.path/d14a2577da362843bb255e84ec3c2dd4bfd47f50
