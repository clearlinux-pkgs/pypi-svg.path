...
Version  : 5.1
Release  : 30
URL      : https://files.pythonhosted.org/packages/90/21/a147a182b5bf99de7abb13857a4a22b239fd6fe195654347b888c1a93d70/svg.path-5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/90/21/a147a182b5bf99de7abb13857a4a22b239fd6fe195654347b888c1a93d70/svg.path-5.1.tar.gz
...
%prep
%setup -q -n svg.path-5.1
cd %{_builddir}/svg.path-5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648150377
...
cp %{_builddir}/svg.path-5.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-svg.path/d14a2577da362843bb255e84ec3c2dd4bfd47f50
